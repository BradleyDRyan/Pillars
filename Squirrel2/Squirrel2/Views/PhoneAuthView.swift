    ...
    var body: some View {
        VStack(spacing: 0) {
            VStack(spacing: 24) {
                ...
                .frame(height: 52)
                .background(phoneNumber.isEmpty ? Color.gray.opacity(0.3) : S2.Colors.squirrelPrimary)
    ...
    var body: some View {
        VStack(spacing: 0) {
            VStack(spacing: 24) {
                ...
                .frame(maxWidth: .infinity)
                .frame(height: 52)
                .background(verificationCode.isEmpty ? Color.gray.opacity(0.3) : S2.Colors.squirrelPrimary)
                .foregroundColor(.white)
                .cornerRadius(12)
                .padding(.horizontal, 24)
